...
def create_window(theme):
    ...
    layout = [
        ...
        [sg.Button('4', size = button_size, expand_x = True), sg.Button('5', size = button_size, expand_x = True), sg.Button('6', size = button_size, expand_x = True), sg.Button('/', size = button_size, expand_x = True)],
        [sg.Button('1', size = button_size, expand_x = True), sg.Button('2', size = button_size, expand_x = True), sg.Button('3', size = button_size, expand_x = True), sg.Button('-', size = button_size, expand_x = True)],
